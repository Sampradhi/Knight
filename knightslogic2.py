...
print(model_check(knowledge0, AKnave))# TODO
...
knowledge1 = And(
    ...
    Or(AKnight,AKnave),
    Or(BKnight,BKnave),
    Not(And(AKnight,AKnave,BKnight,BKnave)),
    Biconditional(AKnight,Not(AKnave)),
    Biconditional(BKnight,Not(BKnave)),
    Implication(AKnight,And(AKnave)),
...
knowledge2 = And(
    ...
    Implication(AKnight,Not(And(AKnight,AKnave,BKnight,BKnave)))
)                  
...
knowledge3 = And(
    ...
    Or(BKnight,BKnave),
    Or(CKnight,CKnave),
    Not(And(AKnight,AKnave,BKnight,BKnave,CKnight,CKnave)),
    Biconditional(AKnight,Not(AKnave)),
    Biconditional(BKnight,Not(BKnave)),
